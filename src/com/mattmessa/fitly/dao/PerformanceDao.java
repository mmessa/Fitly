...
public class PerformanceDao {
	...
	public boolean create(Performance performance) {
		...
		// BeanPropertySqlParameterSource(profile);
		...
		// return jdbc.update("insert into profile (userId, firstName, lastName,
		// image, heightFeet, heightInches, DOB, gender, city, state, zipCode,
		// gym, level, experiencePoints, createTime) values (:userId,
		// :firstName, :lastName, NULL, :heightFeet, :heightInches, NULL, NULL,
		// :city, :state, :zipCode, :gym, 0, 0, NULL)", params) == 1;
		// insert into profile (userId, firstName, lastName, image, heightFeet,
		// heightInches, DOB, gender, city, state, zipCode, gym, level,
		// experiencePoints, createTime) values (3, 'Matt', 'Messa', NULL, 6, 2,
		// NULL, NULL, 'chico' , 'ca', 95928, 'wrec', 0, 0, NULL);
	}
	...
	public Performance getPerformance(int performanceId) {
		...
		return jdbc.queryForObject(
				"select * from performance inner join challenge on performance.challengeId=challenge.challengeId where performance.performanceId=:performanceId",
				params, new RowMapper<Performance>() {
	...
	public List<Performance> getPerformances(int userId) {
		...
		return jdbc.query(
				"select * from performance inner join challenge on performance.challengeId=challenge.challengeId where performance.userId=:userId",
				params, new RowMapper<Performance>() {
	...
	public boolean completePerformance(int performanceId) {
		...
		return jdbc.update(
				"update performance set completedDate=current_timestamp, complete=1 where performanceId=:performanceId",
				params) == 1;
	}
